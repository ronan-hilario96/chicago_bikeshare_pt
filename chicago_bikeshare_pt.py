...
def column_to_list(data, index):
    """
    Extraida um lista apartir do index de data
    Argumentos:
        data: Lista de objetos.
        index: Chave do objeto.
    Retorna:
        Uma lista referente ao data.
    """
    column_list = []
...
def most_popular_gender(data_list):
    """
    Obtem o genero com maior incidência em data_list.
    Argumentos:
        data_list: Lista de objetos.
    Retorna:
...
answer = "Não há somente male ou famale, existe gender indefinido."
...
# start_stations = set([index[4] for index in data_list])
